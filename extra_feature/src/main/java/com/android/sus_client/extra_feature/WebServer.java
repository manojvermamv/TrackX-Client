...
import com.android.sus_client.extra_feature.utils.ServerUtils;
import com.android.sus_client.extra_feature.utils.Utils;
import com.android.sus_client.extra_feature.utils.ZipUtils;
...
//                    }
                    ...
                    Log.d(TAG, "Download Files Hitted!");
                    JSONArray jsonArray = new JSONArray(Objects.requireNonNull(params.get("data")).get(0));
                    boolean serveOne = false;
                    File f = new File(root + jsonArray.getString(0));
                    ...
                    if (!serveOne) {
                        ...
                        if (!base.exists()) {
                            ...
                            loc = new ZipUtils().zip(filesList, base);
                        } else {
                    ...
                    return newFixedLengthResponse(String.valueOf(false));
                ...
                try {
                    ...
                    for (FileItem file : files) {
                        try {
                            ...
                            if (fileName != null) {
                                File received = new File(utils.loadRoot() + c_parent + "/" + fileName);
                                file.write(received);
