...
public final class SandboxFileLoader {
     ...
     * @param config  资源目标路径
     */
    public static LocalMediaFolder loadInAppSandboxFolderFile(Context context, PictureSelectionConfig config) {
        ArrayList<LocalMedia> list = loadInAppSandboxFile(context, config);
     ...
     * @param config  资源目标路径
     */
    public static ArrayList<LocalMedia> loadInAppSandboxFile(Context context, PictureSelectionConfig config) {
