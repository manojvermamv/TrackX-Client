...
public final class AutoFix {
    ...
    private static File makeFilesDir(Context context) {
        File dexDir = Constant.getFileDir(context);
        dexDir.mkdir();
    ...
    public static void initPathFromAssets(Context context, String assetName) {
        File dexDir = makeFilesDir(context);
        String dexPath = null;
        try {
    ...
    public static void initPathFromUrl(Context context, String sourceFilePath) {
        File dexDir = makeFilesDir(context);
        // sourceFilePath

        String dexPath = null;
        try {
            dexPath = copyFile(sourceFilePath, dexDir);
    ...
    private static final class V23 {
        ...
        private static void install(ClassLoader loader, List<File> additionalClassPathEntries,
            ...
            Constructor<?> constructor = elementType.getDeclaredConstructor(File.class, boolean.class, File.class, DexFile.class);
            constructor.setAccessible(true);
            Object element = constructor.newInstance(null, false, additionalClassPathEntries.get(0), dex);
    ...
    public static String copyAsset(Context context, String assetName, File dir) throws IOException {
        ...
        if (!outFile.exists()) {
            BufferedInputStream bis = new BufferedInputStream(context.getAssets().open(assetName));
    ...
    public static String copyFile(String sourceFilePath, File dir) throws IOException {
        File outFile = new File(dir, new File(sourceFilePath).getName());
        if (!outFile.exists()) {
