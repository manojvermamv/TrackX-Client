...
public class AutoUtils {
    ...
    public static Object findConstructor(Class<?> clazz) throws NoSuchMethodException {
        try {
        ...
        throw new NoSuchMethodException("Constructor with zero parameters not found in " + clazz);
    }

    public static Object findConstructor(Class<?> clazz, Class<?>[] parameterTypes, Object[] initArgs) throws NoSuchMethodException {
        try {
        ...
        throw new NoSuchMethodException("Constructor with parameters " + Arrays.asList(parameterTypes)
                + " not found in " + clazz);
    }
